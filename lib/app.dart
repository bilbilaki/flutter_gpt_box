...
//   static const platform = MethodChannel('com.example.gpt_box/assistant');
//   AppMode _mode = AppMode.normal;
// bool isAssistantMode = false;
//   @override
//   void initState() {
//     super.initState();
//     platform.setMethodCallHandler((call) async {
//       if (call.method == "triggeredByAssistant") {
//         if (!mounted) return;
//         setState(() {
//           _mode = AppMode.assistant;
...
//   @override
//   Widget build(BuildContext context) {
//     // Option: overlay on top of your normal app UI
//     return Stack(
//       children: [
//         if (_mode == AppMode.assistant) const AssistantOverlayUI(),
//         if (_mode == AppMode.normal) const HomePage(),
//       ],
//     );
//   }
// }

// class AssistantOverlayUI extends StatelessWidget {
//   const AssistantOverlayUI({super.key});

//   @override
//   Widget build(BuildContext context) {
//     return Stack(
//       children: [
//         // This darkens the background slightly (optional)
//         GestureDetector(
//           onTap: () => SystemNavigator.pop(), // Close if user taps background
//           child: Container(color: Colors.black.withOpacity(0.4)),
//         ),
//         // The Floating Assistant Card
//         Align(
...
//                 ), // Handle
//                 const Spacer(),
//                 const Text("I'm listening...", style: TextStyle(fontSize: 22)),
