...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,prompt,url,key,model,historyLen,id,name,genTitlePrompt,genTitleModel,imgModel,audioModel,tskrModel,altrModel,wrkrModel,trnscrbModel,defaultTranslateLanguage,file,image,audio]);
