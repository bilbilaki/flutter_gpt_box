...
#if __has_include(<google_sign_in_all_platforms_mobile/GoogleSignInAllPlatformsMobilePlugin.h>)
#import <google_sign_in_all_platforms_mobile/GoogleSignInAllPlatformsMobilePlugin.h>
#else
@import google_sign_in_all_platforms_mobile;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [GoogleSignInAllPlatformsMobilePlugin registerWithRegistrar:[registry registrarForPlugin:@"GoogleSignInAllPlatformsMobilePlugin"]];
